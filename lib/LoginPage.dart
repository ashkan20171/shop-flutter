...
class _LoginWidgetState extends State<LoginWidget> {
      ...
      builder:(context) => Stack(
        children: <Widget>[
          Padding(
            ...
            child: Text(
              "SignIn",
              style: TextStyle(fontFamily: "Varela",fontSize: 55,color: Colors.grey[400]),
            ),
          ),
          Center(
                    ...
                    child: InkWell(
                      ...
                      child: Container(
                        ...
                        child: Center(
                          child: Text(
                            "ورود",
                            style: TextStyle(fontFamily: "Vazir",color: Colors.white,fontSize: 20),
                          ),
                        ),
                      ),
                    ),
  ...
  void showMySnackBar(BuildContext context,String message){
    Scaffold.of(context).showSnackBar(
      SnackBar(
        content: Text(message,style: TextStyle(fontFamily: "Vazir",fontSize: 15,),),
      )
    );
  }
}
